...
/* harmony import */ var _wechatJSSDK__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./wechatJSSDK */ "./src/assets/js/wechatJSSDK.js");
...
var shareData = {
  title: jquery__WEBPACK_IMPORTED_MODULE_0___default()("title").html(),
  desc: jquery__WEBPACK_IMPORTED_MODULE_0___default()("meta[name=description]").attr("content"),
  img: jquery__WEBPACK_IMPORTED_MODULE_0___default()("meta[property=wximg]").attr("content"),
  link: window.location.href.split("#")[0]
};
console.log(shareData);
Object(_wechatJSSDK__WEBPACK_IMPORTED_MODULE_3__["setWechatConfig"])(shareData); // Setup
...
__webpack_require__(/*! ./modules/lazyload */ "./src/assets/js/modules/lazyload.js");

__webpack_require__(/*! ./modules/validation */ "./src/assets/js/modules/validation.js");

__webpack_require__(/*! ./modules/mobilemenu */ "./src/assets/js/modules/mobilemenu.js");
...
var observerImages = lozad__WEBPACK_IMPORTED_MODULE_0___default()("[data-lazyload]", {
  ...
  $("form[data-validate]").each(function () {
    ...
    $(this).validate({
      ...
      messages: {
        ...
        confirmpassword: getErrorMsg("#confirmpassword", "data-msg-confirmpassword")
      },
      errorElement: "span",
      ...
      showErrors: function showErrors(errorMap, errorList) {
        ...
        if (errors) {
          var message = errors == 1 ? "Theres an error below, please correct it and try again" : "There are " + errors + " errors below, please correct them and try again";
...
/***/ "./src/assets/js/wechatJSSDK.js":
/*!**************************************!*\
  !*** ./src/assets/js/wechatJSSDK.js ***!
  \**************************************/
/*! exports provided: setWechatConfig */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setWechatConfig", function() { return setWechatConfig; });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);


var getWechatJsConfig = function getWechatJsConfig(params) {
  return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://projects.archisense.cn/wechat/api/share-proxy2.php", {
    params: params
  });
};

var setWechatConfig = function setWechatConfig(meta) {
  getWechatJsConfig({
    ...
    wx.ready(function () {
      ...
      wx.onMenuShareAppMessage({
        ...
        // 如果type是music或video，则要提供数据链接，默认为空
        success: function success() {},
        cancel: function cancel() {// alert('123')
        }
      });
    });
  });
